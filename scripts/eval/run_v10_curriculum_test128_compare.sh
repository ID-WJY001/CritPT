...
DATA=${DATA:-${ROOT}/data/synthetic_critpt/v10_curriculum_trace/test.jsonl}
LIMIT=${LIMIT:-128}
TP=${TP:-2}
...
run_one finalverifier_base_v10_curriculum_test128 \
  "${ROOT}/models/qwen3-8b"
run_one finalverifier_v6_hardcase_b8_gs10_v10_curriculum_test128 \
  "${ROOT}/models/qwen3-8b-auditcot-finalverifier-v6-hardcase-b8-gs10"
run_one finalverifier_v9_trace_n4_b8_gs5_v10_curriculum_test128 \
  "${ROOT}/models/qwen3-8b-audittrace-finalverifier-v9-trace-n4-b8-gs5"

v10_model="${ROOT}/models/qwen3-8b-audittrace-finalverifier-v10-curriculum-n4-b8-gs5"
if [ -d "${v10_model}" ]; then
  run_one finalverifier_v10_curriculum_n4_b8_gs5_v10_curriculum_test128 "${v10_model}"
fi
