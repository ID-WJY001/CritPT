...
DATA=${DATA:-${ROOT}/data/synthetic_critpt/v7_intermediate/test.jsonl}
LIMIT=${LIMIT:-128}
TP=${TP:-2}
...
run_one finalverifier_base_v7_intermediate_test128 \
  "${ROOT}/models/qwen3-8b"
run_one finalverifier_v6_hardcase_b8_gs10_v7_intermediate_test128 \
  "${ROOT}/models/qwen3-8b-auditcot-finalverifier-v6-hardcase-b8-gs10"
run_one finalverifier_v7_intermediate_b8_gs10_v7_intermediate_test128 \
  "${ROOT}/models/qwen3-8b-auditcot-finalverifier-v7-intermediate-b8-gs10"
...
labels = [
    "finalverifier_base_v7_intermediate_test128",
    "finalverifier_v6_hardcase_b8_gs10_v7_intermediate_test128",
    "finalverifier_v7_intermediate_b8_gs10_v7_intermediate_test128",
]
for label in labels:
