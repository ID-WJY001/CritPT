...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate synthetic CritPT predictions with a LoRA adapter.")
    parser.add_argument("--model", required=True, help="base model path")
    parser.add_argument("--adapter", required=True, help="LoRA adapter path, usually .../final_lora")
