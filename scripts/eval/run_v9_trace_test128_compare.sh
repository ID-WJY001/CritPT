...
DATA=${DATA:-${ROOT}/data/synthetic_critpt/v9_trace/test.jsonl}
LIMIT=${LIMIT:-128}
TP=${TP:-2}
...
run_one finalverifier_base_v9_trace_test128 \
  "${ROOT}/models/qwen3-8b"
run_one finalverifier_v6_hardcase_b8_gs10_v9_trace_test128 \
  "${ROOT}/models/qwen3-8b-auditcot-finalverifier-v6-hardcase-b8-gs10"
run_one finalverifier_v9_trace_n4_b8_gs5_v9_trace_test128 \
...
labels = [
    "finalverifier_base_v9_trace_test128",
    "finalverifier_v6_hardcase_b8_gs10_v9_trace_test128",
    "finalverifier_v9_trace_n4_b8_gs5_v9_trace_test128",
]
for label in labels:
