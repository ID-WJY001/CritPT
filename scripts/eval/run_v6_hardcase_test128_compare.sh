...
DATA=${DATA:-${ROOT}/data/synthetic_critpt/v6_hardcase/test.jsonl}
LIMIT=${LIMIT:-128}
TP=${TP:-2}
...
run_one finalverifier_base_v6_hardcase_test128 \
  "${ROOT}/models/qwen3-8b"
run_one finalverifier_v5_continue_b8_gs10_v6_hardcase_test128 \
  "${ROOT}/models/qwen3-8b-auditcot-finalverifier-v5-continue-b8-gs10"
run_one finalverifier_v6_hardcase_b8_gs10_v6_hardcase_test128 \
...
labels = [
    "finalverifier_base_v6_hardcase_test128",
    "finalverifier_v5_continue_b8_gs10_v6_hardcase_test128",
    "finalverifier_v6_hardcase_b8_gs10_v6_hardcase_test128",
]
for label in labels:
