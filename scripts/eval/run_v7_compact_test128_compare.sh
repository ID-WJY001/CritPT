...
run_one finalverifier_base_v7_compact_test128 \
  "${ROOT}/models/qwen3-8b"
run_one finalverifier_v6_hardcase_b8_gs10_v7_compact_test128 \
  "${ROOT}/models/qwen3-8b-auditcot-finalverifier-v6-hardcase-b8-gs10"
run_one finalverifier_v7_compact_b8_gs10_v7_compact_test128 \
  "${ROOT}/models/qwen3-8b-auditshort-finalverifier-v7-compact-b8-gs10"
...
labels = [
    "finalverifier_base_v7_compact_test128",
    "finalverifier_v6_hardcase_b8_gs10_v7_compact_test128",
    "finalverifier_v7_compact_b8_gs10_v7_compact_test128",
]
for label in labels:
