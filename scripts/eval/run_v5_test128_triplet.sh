...
DATA=${DATA:-${ROOT}/data/synthetic_critpt/v5/test.jsonl}
LIMIT=${LIMIT:-128}
TP=${TP:-2}
...
run_one finalverifier_base_v5_test128 \
  "${ROOT}/models/qwen3-8b"
run_one finalverifier_prev_b8_gs10_v5_test128 \
  "${ROOT}/models/qwen3-8b-auditcot-finalverifier-b8-gs10"
run_one finalverifier_v5_continue_b8_gs10_v5_test128 \
...
labels = [
    "finalverifier_base_v5_test128",
    "finalverifier_prev_b8_gs10_v5_test128",
    "finalverifier_v5_continue_b8_gs10_v5_test128",
]
for label in labels:
