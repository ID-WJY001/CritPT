...
RUN_NAME="${RUN_NAME:-qwen3_8b_grpo_v20_focused_hard_from_v19_gs60_n8}"
STEP="${STEP:-40}"
CKPT_DIR="${CKPT_DIR:-${RL_DATA_ROOT}/checkpoints/${RUN_NAME}/global_step_${STEP}/actor}"
TARGET_MODEL="${TARGET_MODEL:-${RL_DATA_ROOT}/models/qwen3-8b-v20-focused-hard-n8-gs${STEP}}"
TMP_MODEL="${TARGET_MODEL}.tmp"
HF_MODEL_CONFIG_PATH="${HF_MODEL_CONFIG_PATH:-${RL_DATA_ROOT}/models/qwen3-8b-v19-failure-mined-n8-gs60}"
...
run_eval() {
  local style="$1"
  local suffix="$2"
  local out_dir="${RL_DATA_ROOT}/logs/eval/qwen3_8b_v20_gs${STEP}_official70_${suffix}_ctx32768_max4096"
